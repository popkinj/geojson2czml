...
(function(){
  var convert;
  convert = function(geojson, options){
    var date, id, elev, label, labels, sorted, first, last, list;
    date = options.date, id = options.id, elev = options.elev, label = options.label;
    labels = geojson.features.reduce(function(a, b){
      var p;
      p = b.properties;
      a[p[id]] = p[label] || '';
      return a;
    }, {});
    sorted = geojson != null ? geojson.features.map(function(it){
      var ref$, ref1$, ref2$, ref3$, ref4$;
      return [(ref$ = it.properties) != null ? ref$[id] : void 8, (ref1$ = it.properties) != null ? ref1$[date] : void 8, (ref2$ = it.geometry) != null ? ref2$.coordinates[0] : void 8, (ref3$ = it.geometry) != null ? ref3$.coordinates[1] : void 8, ((ref4$ = it.properties) != null ? ref4$[elev] : void 8) || 0];
    }).filter(function(it){
      return it[2] && it[3];
    }).sort(function(a, b){
    ...
    */
    list = sorted.reduce(function(a, b){
      var index;
      if ((index = a.findIndex(function(it){
        return deepEq$(it.id, b[0], '===');
      })) > -1) {
        ...
        a.push({
          id: b[0],
          position: {
            cartographicDegrees: [b[1], b[2], b[3], b[4]]
          }
        });
      }
      return a;
    ...
    */
    list.forEach(function(it){
      ...
      end = it.position.cartographicDegrees[it.position.cartographicDegrees.length - 4];
